...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="54" style="background: var(--bs-border-color-translucent);color: rgb(255,255,255);">
    <header class="masthead" style="background-image: url('{{ asset('assets/img/rr.jpg') }}');color: rgba(0,0,0,0.64);">
        ...
        <div class="container" style="text-align: center;">
            <div class="row clearmargin clearpadding row-image-txt" style="background: rgb(42, 42, 42);text-align: center;">
                <div class="col-xs-12 col-sm-12 col-md-12 col-sm-pull-12" style="padding: 22px;text-align: center;padding-bottom: 43px;">
                    <h2 class="d-flex" style="color: rgb(255,215,0);text-align: center;">Intro Video</h2>
                    <hr>
                    <p class="d-md-inline">this is the intro video</p>
                    ...
                    <div class="col-sm-6 col-md-4 portfolio-item">
                        <a class="portfolio-link" href="#portfolioModal1" data-bs-toggle="modal"
                            ...
                            <div class="portfolio-hover">
                                ...
                                src="{{ asset('storage/' . $event->images->first()->image_url) }}">
                        </a>
