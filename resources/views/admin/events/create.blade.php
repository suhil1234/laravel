...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="54" style="background: var(--bs-border-color-translucent);color: rgb(255,255,255);">
    ...
    <section class="bg-dark" id="intro" style="padding-top: 50px;padding-bottom: 50px;text-align: center;padding-right: 12px;padding-left: 12px;"></section>
    <section class="bg-dark" id="portfolio" style="background: rgb(90,43,190);border-color: rgb(205,21,21);color: rgb(40,12,12);padding-bottom: 50px;padding-top: 50px;">
        <div class="container-fluid" style="color: rgb(255,255,255);">
            <div class="row">
                <div class="col-lg-12 text-center" style="background: rgba(255,255,255,0);">
                    <h1 class="text-uppercase text-center section-heading" style="padding-bottom: 43px;color: rgb(255,215,0);border-color: var(--bs-link-color);">&nbsp;Add Event</h1>
                    @if(session('success'))
    ...
    @endif
        ...
        <div class="row register-form">
            <div class="col-md-8 offset-md-2">
                <form class="custom-form" action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data" style="color: rgb(255,255,255);background: rgba(255,255,255,0);">
                 @csrf
                    <h1 style="color: var(--bs-link-color);">Add Event</h1>
                    <div class="row form-group">
                        <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field" style="color: #ffffff;">Title</label></div>
                        <div class="col-sm-6 input-column"><input class="form-control" type="text" name="title" id="title" required></div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-sm-6 input-column"><textarea class="form-control" name="description" id="description" required></textarea></div>
                    </div>
                    <div class="row form-group">
                        <div class="col-sm-4 label-column"><label class="col-form-label" for="pawssword-input-field" style="color: #ffffff;">Time</label></div>
                        <div class="col-sm-6 input-column"><input class="form-control" type="datetime-local" id="time" name="time" value="{{ old('time') }}" required></div>
                    </div>
                    <div class="row form-group">
                        <div class="col-sm-4 label-column"><label class="col-form-label" for="repeat-pawssword-input-field" style="color: #ffffff;">Image</label></div>
                        <div class="col-sm-6 input-column"><input class="form-control" type="file" name="image" id="image" required></div>
                    </div><button class="btn btn-light submit-button" type="submit" style="background: var(--bs-warning);color: #2c2b2b;">Add Event</button>
                </form>
            </div>
        </div>
    </section>
